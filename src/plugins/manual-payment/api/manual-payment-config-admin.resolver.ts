...
export class ManualPaymentConfigAdminResolver {
  ...
  @Query()
  @Allow(Permission.SuperAdmin, Permission.ReadPaymentMethod)
  ...
  @Mutation()
  @Transaction()
  @Allow(Permission.SuperAdmin, Permission.CreatePaymentMethod)
  ...
  @Mutation()
  @Transaction()
  @Allow(Permission.SuperAdmin, Permission.UpdatePaymentMethod)
  ...
  @Mutation()
  @Transaction()
  @Allow(Permission.SuperAdmin, Permission.DeletePaymentMethod)
  async deleteManualPaymentConfig(
    @Ctx() ctx: RequestContext,
    @Args() args: { id: ID }
